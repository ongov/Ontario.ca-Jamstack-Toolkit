    ...
    .then((answers) => {
      ...
      inquirer
        ...
        .then((answers) => {
          ...
          fs.renameSync('README.fr.md', 'README.jamstack.fr.md');
          console.log('Renamed default README files');
  ...
  inquirer
    ...
    .then((answers) => {
      ...
      const coreFileReplacements = coreFilePaths.map((filePath) => {
        return [`./${tmpCheckoutDir}${filePath}`, `.${filePath}`];
      });
        ...
        function (error) {
          ...
          git().diff(
            ...
            function (error, diff) {
              ...
              fs.outputFileSync(ignoreFile, ignoreFileContent);
              try {
                coreFileReplacements.forEach((filePathStruct, idx) => {
                  console.log(
