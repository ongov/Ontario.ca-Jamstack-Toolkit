...
function addA11yVisiblity(element) {
    element.style.visibility = "visible";
    element.setAttribute("aria-hidden", false);
    element.setAttribute("tabindex", -1);
}

function removeA11yVisiblity(element) {
...
function focusUser(config) {
    ...
    var focusableElements = element.querySelectorAll("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, [tabindex='0'], [contenteditable]");
    var keyboardHandler;
